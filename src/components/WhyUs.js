const WhyUs = () => {
    return (
        <div className="px-20 py-28">
            <h1 className="text-center text-6xl font-bold text-primary-color">
                Why WCC?
            </h1>
            <div className="flex py-20">
                <div>
                    <h2 className="text-primary-color font-semibold text-lg">
                        Community Learning
                    </h2>
                ...
                <div>
                    ...
                    <p className="leading-relaxed py-2.5">
                        ...
                        the tech industry with Devmountain’s career-focused
                        curriculum, and you can get help with establishing the
                        right connections, too.
                    </p>
                </div>
            </div>
        </div>
